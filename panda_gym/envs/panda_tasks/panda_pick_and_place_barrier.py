...
from panda_gym.envs.tasks import PickAndPlaceBarrier


class PandaPickAndPlaceBarrierEnv(RobotTaskEnv):
    ...
    def __init__(self, render=False, reward_type="sparse"):
        ...
        self.task = PickAndPlaceBarrier(self.sim, reward_type=reward_type)
