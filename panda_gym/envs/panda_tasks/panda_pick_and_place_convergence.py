...
from panda_gym.envs.tasks import PickAndPlaceConvergence


class PandaPickAndPlaceConvergenceEnv(RobotTaskEnv):
    ...
    def __init__(self, render=False, reward_type="sparse"):
        ...
        self.task = PickAndPlaceConvergence(self.sim, reward_type=reward_type)
