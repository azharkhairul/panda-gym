...
from panda_gym.envs.tasks import PickAndPlaceDense


class PandaPickAndPlaceDenseEnv(RobotTaskEnv):
    ...
    def __init__(self, render=False, reward_type="sparse"):
        ...
        self.task = PickAndPlaceDense(self.sim, reward_type=reward_type)
