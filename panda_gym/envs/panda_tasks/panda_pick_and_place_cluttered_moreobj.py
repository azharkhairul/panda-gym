...
from panda_gym.envs.tasks import PickAndPlaceClutteredMoreObj


class PandaPickAndPlaceClutteredMoreObjEnv(RobotTaskEnv):
    ...
    def __init__(self, render=False, reward_type="sparse"):
        ...
        self.task = PickAndPlaceClutteredMoreObj(self.sim, reward_type=reward_type)
