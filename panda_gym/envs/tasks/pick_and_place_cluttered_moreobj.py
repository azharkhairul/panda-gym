...
from panda_gym.utils import distance, compareemoreobj
from pyrsistent import b

class PickAndPlaceClutteredMoreObj(Task):
    ...
    def get_obs(self):
        ...
        object_position4 = np.array(self.sim.get_base_position("object4"))
        object_rotation4 = np.array(self.sim.get_base_rotation("object4"))
        object_velocity4 = np.array(self.sim.get_base_velocity("object4"))
        object_angular_velocity4 = np.array(self.sim.get_base_angular_velocity("object4"))

        object_position5 = np.array(self.sim.get_base_position("object5"))
        object_rotation5 = np.array(self.sim.get_base_rotation("object5"))
        object_velocity5 = np.array(self.sim.get_base_velocity("object5"))
        object_angular_velocity5 = np.array(self.sim.get_base_angular_velocity("object5"))

        object_position6 = np.array(self.sim.get_base_position("object6"))
        object_rotation6 = np.array(self.sim.get_base_rotation("object6"))
        ...
        observation = np.concatenate(
            [
                ...
                object_rotation4,
                object_velocity4,
                object_angular_velocity4,

                object_position5,
                object_rotation5,
                object_velocity5,
                object_angular_velocity5,
    ...
    def reset(self):
        ...
        self.previous_object4 = []
        self.previous_object4 = object4_position
        self.previous_object5 = []
    ...
    def _sample_object(self):
        ...
        while True:
            ...
            if (
                ...
                distance(object1_position, object6_position) > 0.05 and 
    ...
    def compute_reward(self, achieved_goal, desired_goal, info):
        ...
        self.previous_object4 = []
        self.previous_object4 = current_object4
        self.previous_object5 = []
